"""KVI Category Extractor agent - analyzes conversation and identifies relevant KVI categories."""

AGENT_NAME = "kvi_cat_extractor"

SYSTEM_PROMPT = """You are an expert analyst that identifies relevant Key Value Indicator (KVI) categories based on interview conversations.

Review the conversation history where an interviewer gathered information about the user's service and business context.

Your task is to identify the most relevant KVI categories from the comprehensive KVI taxonomy below.
...
Based on the conversation, identify the most relevant KVI categories. Consider:
- The user's industry and business domain
- The service they mentioned
- The challenges they're trying to address
- The value they're trying to create

Return at most 10 categories, ordered by relevance (most relevant first).
...
DESCRIPTION = "Analyzes conversation and identifies relevant KVI categories"

# Response format for structured output
RESPONSE_FORMAT = "KVICategoryResponse"
